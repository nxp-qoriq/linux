...
extern const struct xdp_metadata_ops ecat_enetc_xdp_metadata_ops;
extern const struct xsk_tx_metadata_ops ecat_enetc_xsk_tx_metadata_ops;
...
void ecat_enetc_eee_mode_set(struct net_device *dev, bool enable);
