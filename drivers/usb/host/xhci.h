...
#define XHCI_STOP_EP_IN_U1	BIT_ULL(34)
...
#define XHCI_DIS_U1U2_WHEN_U3 BIT_ULL(35)
#define XHCI_RESET_PLL_ON_DISCONNECT    BIT_ULL(36)
#define XHCI_SNPS_BROKEN_SUSPEND    BIT_ULL(37)
